...
def combine_datasets(
    ...
    Args:
        ...
        llama_nemo_dir: Directory containing Llama Nemotron files (default: None)
    ...
    if os.path.exists(train_file):
        print("Train file exists. Skipping save.")
    else:
    ...
    if os.path.exists(val_file):
        print("Val file exists. Skipping save.")
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--llama_nemo_dir", type=str, default=None,
                      help="Directory containing Llama Nemotron files (optional)")
